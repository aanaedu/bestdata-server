...
exports.update = function (req, res) {
    ...
    if (req.body.gender) {newStudent.gender = req.body.gender; }
    if (req.body.dateOfBirth) {newStudent.dateOfBirth = req.body.dateOfBirth; }
    if (req.body.phoneNumber) {newStudent.phoneNumber = req.body.phoneNumber; }
    if (req.body.email) {newStudent.email = req.body.email; }
    if (req.body.address) {newStudent.address = req.body.address; }
